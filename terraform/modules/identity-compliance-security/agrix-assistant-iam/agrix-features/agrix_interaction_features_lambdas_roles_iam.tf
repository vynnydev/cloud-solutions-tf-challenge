...
resource "aws_iam_role" "agrix_interaction_features_lambda_role" {
  name = "agrix_interaction_features_lambda_role"
...
resource "aws_iam_role_policy" "dynamodb_access" {
  ...
  role = aws_iam_role.agrix_interaction_features_lambda_role.id
...
resource "aws_iam_role_policy_attachment" "lambda_basic_execution" {
  ...
  role       = aws_iam_role.agrix_interaction_features_lambda_role.name
}