...
resource "aws_lambda_function" "tasks_results_merge" {
  function_name    = "tasks_results_merge"
  role             = var.tasks_results_merge_lambda_role_arn
  handler          = "tasks_results_merge.lambda_handler"
  runtime          = "python3.9"
