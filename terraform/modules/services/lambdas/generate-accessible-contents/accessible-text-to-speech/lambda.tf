...
resource "aws_lambda_function" "accessible_text_to_speech" {
  function_name    = "accessible_text_to_speech"
  role             = var.accessible_text_to_speech_lambda_role_arn
  handler          = "accessible_text_to_speech.lambda_handler"
  runtime          = "python3.9"
