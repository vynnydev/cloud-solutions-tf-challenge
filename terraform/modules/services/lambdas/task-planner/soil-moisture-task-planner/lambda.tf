...
resource "aws_lambda_function" "soil_moisture_task_planner" {
  function_name    = "soil_moisture_task_planner"
  role             = var.soil_moisture_task_planner_lambda_role_arn
  handler          = "soil_moisture_task_planner.lambda_handler"
  runtime          = "python3.9"
