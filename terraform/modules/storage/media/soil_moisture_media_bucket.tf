...
resource "aws_s3_bucket" "soil_moisture_media_bucket" {
  bucket = "soil-moisture-media-bucket"

  tags = {
    Name        = "soil-moisture-media-bucket"
    Environment = "Production"
  }
}

# S3 Bucket Ownership Controls
resource "aws_s3_bucket_ownership_controls" "soil_moisture_media_bucket_ownership" {
...
resource "aws_s3_bucket_acl" "soil_moisture_media_bucket_acl" {
  depends_on = [aws_s3_bucket_ownership_controls.soil_moisture_media_bucket_ownership]
