...
resource "aws_lambda_function" "tasks_management" {
  function_name    = "tasks_management"
  role             = var.tasks_management_lambda_role_arn
  handler          = "tasks_management.lambda_handler"
  runtime          = "python3.9"
